...
class WarningDialog(Gtk.Dialog):
    ...
    def __init__(self, parent, message):
        Gtk.Dialog.__init__(self, u"Увага", parent, 0,
                            (u"Відміна", Gtk.ResponseType.CANCEL,
                             u"Гаразд", Gtk.ResponseType.OK)
                            )
        ...
        #u""" Для роботи з наступним відео слід \nзавершити роботу з теперішнім. \n Бажаєте закрити відео?"""
...
class StatusWindowWidgets:
    ...
    def __init__(self, main):
        ...
        builder = Gtk.Builder()
        builder.add_from_file(os.path.join(CURRENT_DIRECTORY, "ui/status_box.glade"))
    ...
    def on_detection_completed(self):
        ...
        self.label_status_message.set_text(u"Обробку завершено.")
...
class FilterWindowWidgets:
    ...
    def __init__(self):
        ...
        builder = Gtk.Builder()
        builder.add_from_file(os.path.join(CURRENT_DIRECTORY, "ui/filter_window.glade"))
...
class SettingsWindowWidgets:
    ...
    def __init__(self):  # , builder):
        ...
        builder = Gtk.Builder()
        builder.add_from_file(os.path.join(CURRENT_DIRECTORY, "ui/settings_window.glade"))
        ...
        self.label_video = builder.get_object("label_video")
        self.label_video.set_text(u"Оберіть відео файл...")
        ...
        self.label_res = builder.get_object("label_res")
        ...
        l = self.button_process.get_child()
        l.set_markup(u"<b>Обробити</b>")  # <big></big>
        print l
        ...
        self.box_additional_prefs = builder.get_object("box4")
    ...
    def deactivate_controls(self):
        ...
        self.box_additional_prefs.set_opacity(0.8)
        self.box_additional_prefs.set_sensitive(False)
        self.button_process.set_opacity(0.8)
        self.button_process.set_sensitive(False)
        self.button_cancel.set_opacity(0.8)
        self.button_cancel.set_sensitive(False)

    def activate_controls(self):

        self.box_additional_prefs.set_opacity(1.0)
        self.box_additional_prefs.set_sensitive(True)
        self.button_process.set_opacity(1.6)
        self.button_process.set_sensitive(True)
        self.button_cancel.set_opacity(1.0)
        self.button_cancel.set_sensitive(True)

    def on_video_open(self, video_path, video_duration):

        # self.entry_video.set_text(video_path)
        self.label_video.set_text(video_path)
